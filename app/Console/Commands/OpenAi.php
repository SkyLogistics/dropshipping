    ...
    #[NoReturn] public function handle(): void
    {
        ...
        if ($prompts) {
            foreach ($prompts as $prompt) {
                $translateRu = 'Написать ключевые SEO слова с разделителем "," для текста - "' . $prompt->title . '" и такими условиями - цифр не должно быть, без кода товара по типу CH114, без сантиметров, без ширины без высоты, без штук, без шт';
                $translateUa = 'Написати ключові SEO слова з роздільником "," для тексту - "' . $prompt->title_ua . '" і такими умовами - цифр не повинно бути, без коду товару на кшталт CH114, без сантиметрів, без ширини без висоти, без штук, без шт';
