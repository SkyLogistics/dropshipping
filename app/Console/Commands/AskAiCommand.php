...
//        $client = new Client($transport);
        ...
        $complete = json_decode(
            $client->complete(
                [
                    'engine' => 'davinci',
                    'prompt' => "Будь копірайтером. Напиши опис для картини по номерах - на передньому плані плавають два лебеді, доторкаючись один до одного клювами, утворюючи ніби серце. У воді видно відзеркалення лебедів та дерев, що є по боках на березі. На задньому плані картини видно міст. Міст виглядає дуже романтично. Це восени. Кожен абзац обрамити в тег <p>.",
                    'temperature' => 0.9,
                    'max_tokens' => 1700,
                    'frequency_penalty' => 0,
