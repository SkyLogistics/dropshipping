...
//            ->where('description_ua', '=', '')
        ...
        if ($prompts) {
            foreach ($prompts as $prompt) {
                ...
                $translateUa = 'Написати ключові SEO слова з роздільником "," українською мовою для тексту - "' . $prompt->name . '" та з такими умовами - цифр не повинно бути, без коду товару по типу CH114, сантиметрiв, без ширини, без, без висоти, без штук, без шт';
