...
//            ->where('description_ua', '=', '')
        ...
        if ($prompts) {
            foreach ($prompts as $prompt) {
                $translateRu = 'Написать ключевые слова на русском языке для "' . $prompt->name.'" с разделителем "," (без кода товара по типу CH114, сантиметров, ширины и высоты, штук, шт)';
                $translateUa = 'Написати ключові слова українською мовою для "' . $prompt->name.'" з роздільником "," (без коду товару по типу CH114, сантиметрiв, ширини та висоти, штук, шт)';
