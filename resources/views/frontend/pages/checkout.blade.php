                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="first_name" placeholder=""
                                               value="@if(\Illuminate\Support\Facades\Auth::user()){{trim(\Illuminate\Support\Facades\Auth::user()->name)}}@else
                                               {{old('first_name')}}" value="{{old('first_name')}}@endif
                                            ">
                                        @error('first_name')
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="email" name="email" placeholder="" value="@if(\Illuminate\Support\Facades\Auth::user()){{trim(\Illuminate\Support\Facades\Auth::user()->email)}}@else
                                        {{old('email')}}" value="{{old('email')}}@endif">
                                        @error('email')
                                        <span class='text-danger'>{{$message}}</span>
                                        @enderror
                                    </div>
